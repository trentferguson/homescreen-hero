...
import type { TMDbSettings, TMDbMissingItem } from "../../types/integrations";

const initialSettings: TMDbSettings = {
    enabled: false,
    api_key: "",
...
export function TMDbIntegration() {
    ...
    const integration = useListIntegration<TMDbSettings, TMDbMissingItem>({
        integrationName: "tmdb",
        initialSettings,
        hasSettings: true,
        healthEndpoint: "/api/health/tmdb",
    });
    ...
    return (
        <div className="space-y-4">
            ...
            <ConfigPanel
                ...
                description="Configure your TMDb API credentials and settings."
            >
                <FieldRow
                    label="Enable TMDb"
                    description="Toggle syncing TMDb lists to your Plex collections."
                >
                ...
                <FieldRow label="API Key" description="Get a free API key from themoviedb.org under Settings > API.">
                    <input
                        type="password"
                        placeholder="••••••••"
                ...
                <FieldRow
                    label="Base URL"
                    description="Override only if using a TMDb API proxy."
                >
                    <input
                        type="url"
            ...
            {/* Source List */}
            <SourceListManager<TMDbMissingItem>
                title="TMDb Lists"
                description="Add or remove TMDb list sources that sync into Plex collections."
                urlPlaceholder="https://www.themoviedb.org/list/123456"
                    ...
                    >
                        <div className="flex-1 min-w-0">
                            ...
                            <div className="flex gap-2 mt-1 text-xs text-slate-500 font-mono flex-wrap">
                                ...
                                {item.media_type && <span>Type: {item.media_type}</span>}
                            </div>
                        </div>
